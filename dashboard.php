        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="dashboard.php" class="nav-item nav-link active"><i class="bi bi-speedometer2 me-2"></i>Reservations</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-primary">Reservations</h6>
                    </div>
                                ...
                                if (count($results3) > 0) {
                                    foreach ($results3 as $row) {
                                        echo "<tr>
                                                ...
                                                $bookStatusClass = '';
                                                if ($row['book_status'] == 'CLOSED') {
                                                    $bookStatusClass = 'text-danger';
                                                } else if ($row['book_status'] == 'IN PROGRESS') {
                                                    $bookStatusClass = 'text-success';
                                                }
                                                
                                                echo "<td class='fw-semibold " . $bookStatusClass . "'>" . $row['book_status'] . "</td>
                                                      <td>" . $row['book_date'] . "</td>";
                                        
                                                // Check if book status is "CLOSED"
                                                if ($row['book_status'] == 'CLOSED') {
                                                    echo "<td style='text-align: center;'><button class='btn btn-sm btn-primary' disabled>Validate</button></td>";
                                                } else {
                                                    echo "<td style='text-align: center;'><button class='btn btn-sm btn-primary validate-btn'  data-book-id='" . $row['book_id'] . "'>Validate</button></td>
                                                    ";
                                                }
