        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="members.php" class="nav-item nav-link active"><i class="bi bi-people me-2"></i>Members</a>
                </div>
            </nav>
        </div>
    ...
    if (count($results1) > 0) {
        foreach ($results1 as $row) {
            echo "<tr>
                    ...
                    <td>" . $row['mem_penalty'] . "</td>
                    <td>" . $row['mem_res'] . "</td>
                    <td>" . $row['mem_email'] . "</td>
                    <td>" . $row['mem_type'] . "</td>
                    <td>" . $row['mem_phone'] . "</td>
                    <td><button class='btn btn-sm btn-danger' data-mem-id='" . $row['mem_id'] . "'>Delete</button></td>
                    </tr>";
        }
    }
?>
...
$(document).ready(function() {
    $("button[data-mem-id]").click(function(e) {
        e.preventDefault();
