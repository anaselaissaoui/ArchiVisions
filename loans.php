        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="loans.php" class="nav-item nav-link active"><i class="bi bi-archive me-2"></i>Loans</a>
                    <a href="works.php" class="nav-item nav-link"><i class="bi bi-file-richtext-fill me-2"></i>Works</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-primary">Loans</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Validate Return</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    if (count($results3) > 0) {
        foreach ($results3 as $row) {
            ...
            if ($row['loan_status'] == 'CLOSED') {
                $loanStatusClass = 'text-danger';
            } else if ($row['loan_status'] == 'LATE') {
                $loanStatusClass = 'text-warning';
            } else if ($row['loan_status'] == 'OPEN') {
                $loanStatusClass = 'text-success';
            }
            echo "<td class='fw-semibold " . $loanStatusClass . "'>" . $row['loan_status'] . "</td>
                  <td>" . $row['loan_date'] . "</td>";

            // Check if loan status is "CLOSED"
            if ($row['loan_status'] == 'CLOSED' || $row['loan_status'] == 'LATE') {
                echo "<td><button class='btn btn-sm btn-primary' disabled>Validate</button></td>";
            } else {
                echo "<td><button class='btn btn-sm btn-primary' data-loan-id='" . $row['loan_id'] . "'>Validate</button></td>";
            }
...
$(document).ready(function() {
    $("button[data-loan-id]").click(function(e) {
        e.preventDefault();
