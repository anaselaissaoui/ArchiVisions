...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (empty($Name) || empty($Email) ||  empty($Password) || empty($RePassword)) {
		...
		$error = 'Invalid email format';
            ...
            $stmt = $conn->prepare("INSERT INTO librarian (lib_name, lib_email, lib_pass) 
            VALUES (:lib_name, :lib_email, :lib_pass)");
             
                $stmt->bindParam(':lib_name', $Name);
               
                $stmt->bindParam(':lib_email', $Email);
                $stmt->bindParam(':lib_pass', $Password);
